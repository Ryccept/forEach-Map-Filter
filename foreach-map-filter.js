...
function onlyEvenValues(arr){
    let newArray = arr.filter(function(v){
        if(v%2 != 1){
            return v
        }
    })
...
function valTimesIndex(arr){
    let newArray = arr.map(function(val, i){
        return val*i;
    })
...
//note: the 0 here is what gets you the first element or an undefined. 
}
/*
...
function removeVowels(str) {
    ...
    return str
      ...
      .join("");
  //remember, chaining is happening left to right here
}
